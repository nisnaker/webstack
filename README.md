...
----
docker run --rm -it --name rsync_server -v /dst:/data -e ROLE=server -p 873 rsync

docker run --rm -it --name rsync_client -v /src:/data -e ROLE=client -e REMOTE_HOST=172.17.0.1 rsync
